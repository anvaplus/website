...
const socialLinks = [
  ...
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/ing-andrei-vasiliu/',
    icon: (
      <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
export default function Footer() {
  ...
  // Use the same email and phone obfuscation technique as in ContactForm
  useEffect(() => {
    const encodedEmail = 'aW5nLmFuZHJlaS52YXNpbGl1QGdtYWlsLmNvbQ==';
    const encodedPhone = 'KzM5IDMyOCA1NTkgMTAyNA==';
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-600 dark:text-gray-400">Phone: {phone}</li>
              <li className="text-gray-600 dark:text-gray-400">Email: {email}</li>
              <li className="text-gray-600 dark:text-gray-400">Location: Bologna, Italy</li>
              <li><a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Download Resume</a></li>
            </ul>
          </div>
